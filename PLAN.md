...
- Коммиты сразу в main, push после каждого коммита.
- Автор коммитов -- только lixonik (deimos.75@mail.ru), без Co-Authored-By.
- Все артефакты кастомизации и скрипты сборки живут в этом репо;
  intellij-community не коммитится и не пушится.
- Состояние автономного цикла -- в STATUS.md (сторожевой cron каждые 10 минут).
- Не беспокоить пользователя уведомлениями до 2026-07-18 21:00.
