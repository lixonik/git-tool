...
По просьбе владельца предустановлен плагин Classic UI (классический интерфейс
вместо New UI). Нюанс: для релиза 2025.2 Marketplace не публикует совместимой
версии (единственная 252-версия ограничена EAP-срезом 252.13776.*), поэтому
setup.ps1 ставит её с расширенным until-build. Плагин -- крошечный маркер
(код классического UI живёт в платформе), риск минимален; если после
обновления интерфейс не переключился -- удалить каталог
config\plugins\classic-ui. Для сборки из исходников (262) ставится штатная
совместимая версия без патчей.
